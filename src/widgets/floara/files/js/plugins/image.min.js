...
!function (a) {
    ...
    ye.extend(ye.FE.POPUP_TEMPLATES, {
        ...
        imageUpload: true,
        imageUploadURL: '/site/froala-upload',
        ...
        var g, l, f, d, o, a, u = "https://i.froala.com/upload", t = !1, i = 1, c = 2, m = 3, h = 4, v = 5, b = 6,
            y = 8, r = {};
        ...
        function N(e) {
            ...
            try {
                if (p.opts.imageUploadToS3) if (201 == t) {
                    var s = function (e) {
                        try {
                            var t = ye(e).find("Location").text(), a = ye(e).find("Key").text();
                    ...
                    s && P(s, !1, [], e, a || i)
                } else U(h, a || i, e); else if (200 <= t && t < 300) {
                    var n = function (e) {
                        try {
            ...
            if (void 0 !== e && 0 < e.length) {
                ...
                if ((null === p.opts.imageUploadURL || p.opts.imageUploadURL == u) && !p.opts.imageUploadToS3) return n = i, o = t || g, (l = new FileReader).addEventListener("load", function () {
                    ...
                    if (l.result.indexOf("svg+xml") < 0) {
                        ...
                        e = window.URL.createObjectURL(new Blob([new Uint8Array(a)], {type: n.type})), p.image.insert(e, !1, null, o)
                    }
        ...
        function H(e) {
            ...
            var i = p.opts.imageInsertButtons.indexOf("imageUpload"),
                r = p.opts.imageInsertButtons.indexOf("imageByURL"), s = "";
            ...
            _init: function () {
                ...
                p.events.$on(p.$el, p._mousedown, "IMG" == p.el.tagName ? null : 'img:not([contenteditable="false"])', function (e) {
                    ...
                    for (var e = 0; e < i.length; e++) {
                        var t = i[e].style.width || ye(i[e]).width(), a = i[e].style.height || ye(i[e]).height();
            ...
            insertByURL: function () {
                ...
                if (0 < e.val().length) {
                    ...
                    if (p.opts.imageUploadRemoteUrls && p.opts.imageCORSProxy && p.opts.imageUpload) {
                        ...
                        a.onload = function () {
                            200 == this.status ? _([new Blob([this.response], {type: this.response.type || "image/png"})], g) : U(i)
                        }, a.onerror = function () {
                            P(t, !0, [], g)
    ...
    }, ye.FE.DefineIcon("insertImage", {NAME: "image"}), ye.FE.RegisterShortcut(ye.FE.KEYCODE.P, "insertImage", null, "P"), ye.FE.RegisterCommand("insertImage", {
        title: "Insert Image",
        undo: !1,
        focus: !0,
        ...
        plugin: "image"
    }), ye.FE.DefineIcon("imageUpload", {NAME: "upload"}), ye.FE.RegisterCommand("imageUpload", {
        title: "Upload Image",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), ye.FE.DefineIcon("imageByURL", {NAME: "link"}), ye.FE.RegisterCommand("imageByURL", {
        title: "By URL",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), ye.FE.DefineIcon("imageDisplay", {NAME: "star"}), ye.FE.RegisterCommand("imageDisplay", {
        title: "Display",
        type: "dropdown",
    ...
    }), ye.FE.DefineIcon("image-align", {NAME: "align-left"}), ye.FE.DefineIcon("image-align-left", {NAME: "align-left"}), ye.FE.DefineIcon("image-align-right", {NAME: "align-right"}), ye.FE.DefineIcon("image-align-center", {NAME: "align-justify"}), ye.FE.DefineIcon("imageAlign", {NAME: "align-justify"}), ye.FE.RegisterCommand("imageAlign", {
        type: "dropdown",
        title: "Align",
        options: {left: "Align Left", center: "None", right: "Align Right"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = ye.FE.COMMANDS.imageAlign.options;
    ...
    }), ye.FE.DefineIcon("imageRemove", {NAME: "trash"}), ye.FE.RegisterCommand("imageRemove", {
        title: "Remove",
        callback: function () {
            this.image.remove()
        }
    }), ye.FE.DefineIcon("imageBack", {NAME: "arrow-left"}), ye.FE.RegisterCommand("imageBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), ye.FE.DefineIcon("imageStyle", {NAME: "magic"}), ye.FE.RegisterCommand("imageStyle", {
        title: "Style",
        type: "dropdown",
        html: function () {
        ...
        refreshOnShow: function (e, t) {
            ...
            a && t.find(".fr-command").each(function () {
                var e = ye(this).data("param1"), t = a.hasClass(e);
                ye(this).toggleClass("fr-active", t).attr("aria-selected", t)
            })
        }
    }), ye.FE.DefineIcon("imageAlt", {NAME: "info"}), ye.FE.RegisterCommand("imageAlt", {
        undo: !1,
        focus: !1,
        popup: !0,
    ...
    }), ye.FE.DefineIcon("imageSize", {NAME: "arrows-alt"}), ye.FE.RegisterCommand("imageSize", {
        undo: !1,
        focus: !1,
        popup: !0,
        title: "Change Size",
