...
!function (i) {
    ...
    Z.extend(Z.FE.POPUP_TEMPLATES, {
        ...
        videoUploadParams: {},
        videoUploadToS3: !1,
        videoUploadURL: '/site/froala-upload'
        ...
        var a, f, p, u, o, i, l = "https://i.froala.com/upload", d = 2, c = 3, h = 4, g = 5, m = 6, r = {};
        ...
        function s() {
            ...
            if (e || (e = function () {
                ...
                var t = u.find("iframe, embed, video"), i = t.offset().left + t.outerWidth() / 2,
        ...
        function n(e) {
            ...
            var i, o = "", r = v.opts.videoInsertButtons.indexOf("videoUpload"),
        ...
        function R(e) {
            ...
            try {
                if (v.opts.videoUploadToS3) if (201 == t) {
                    var s = function (e) {
                        try {
                            var t = Z(e).find("Location").text(), i = Z(e).find("Key").text();
                    ...
                    s && E(s, !1, [], e, i || o)
                } else N(h, i || o); else if (200 <= t && t < 300) {
                    var n = function (e) {
                        try {
        ...
        function M(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if ((null === v.opts.videoUploadURL || v.opts.videoUploadURL == l) && !v.opts.videoUploadToS3) return a = i, (d = new FileReader).addEventListener("load", function () {
                    ...
                    E(window.URL.createObjectURL(new Blob([new Uint8Array(t)], {type: a.type})), !1, null, u)
                ...
                if (v.drag_support.formdata && (t = v.drag_support.formdata ? new FormData : null), t) {
                    ...
                    s.onload = function () {
                        R.call(s, u)
                    }, s.onerror = S, s.upload.onprogress = U, s.onabort = D, C(), v.events.disableBlur(), v.edit.off(), v.events.enableBlur();
        ...
        return r[1] = "Video cannot be loaded from the passed link.", r[d] = "No link in upload response.", r[c] = "Error during file upload.", r[h] = "Parsing response failed.", r[g] = "File is too large.", r[m] = "Video file type is invalid.", r[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", v.shared.vid_exit_flag = !1, {
            ...
            }, upload: M, insertByURL: function (e) {
            ...
            }, remove: K, hideProgressBar: A, showSizePopup: function () {
                var e = v.popups.get("video.size");
                e || (e = Y()), A(), v.popups.refresh("video.size"), v.popups.setContainer("video.size", v.$sc);
                var t = u.find("iframe, embed, video"), i = t.offset().left + t.width() / 2,
        ...
        NAME: "video-camera",
        FA5NAME: "camera"
    }), Z.FE.DefineIcon("videoByURL", {NAME: "link"}), Z.FE.RegisterCommand("videoByURL", {
        title: "By URL",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), Z.FE.DefineIcon("videoEmbed", {NAME: "code"}), Z.FE.RegisterCommand("videoEmbed", {
        title: "Embedded Code",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), Z.FE.DefineIcon("videoUpload", {NAME: "upload"}), Z.FE.RegisterCommand("videoUpload", {
        title: "Upload Video",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), Z.FE.DefineIcon("videoDisplay", {NAME: "star"}), Z.FE.RegisterCommand("videoDisplay", {
        title: "Display",
        type: "dropdown",
    ...
    }), Z.FE.DefineIcon("video-align", {NAME: "align-left"}), Z.FE.DefineIcon("video-align-left", {NAME: "align-left"}), Z.FE.DefineIcon("video-align-right", {NAME: "align-right"}), Z.FE.DefineIcon("video-align-center", {NAME: "align-justify"}), Z.FE.DefineIcon("videoAlign", {NAME: "align-center"}), Z.FE.RegisterCommand("videoAlign", {
        type: "dropdown",
        title: "Align",
        options: {left: "Align Left", center: "None", right: "Align Right"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Z.FE.COMMANDS.videoAlign.options;
    ...
    }), Z.FE.DefineIcon("videoRemove", {NAME: "trash"}), Z.FE.RegisterCommand("videoRemove", {
        title: "Remove",
        callback: function () {
            this.video.remove()
        }
    }), Z.FE.DefineIcon("videoSize", {NAME: "arrows-alt"}), Z.FE.RegisterCommand("videoSize", {
        undo: !1,
        focus: !1,
        popup: !0,
        title: "Change Size",
    ...
    }), Z.FE.DefineIcon("videoBack", {NAME: "arrow-left"}), Z.FE.RegisterCommand("videoBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
