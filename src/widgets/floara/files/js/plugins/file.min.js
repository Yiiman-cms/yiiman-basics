...
!function (i) {
    ...
    E.extend(E.FE.POPUP_TEMPLATES, {"file.insert": "[_BUTTONS_][_UPLOAD_LAYER_][_PROGRESS_BAR_]"}), E.extend(E.FE.DEFAULTS, {
        fileUpload: true,
        fileUploadURL: '/site/froala-upload',
        ...
        var r, p = "/site/upload-froala", l = 2, d = 3, u = 4, c = 5, v = 6, i = {};
        ...
        function m(e) {
            ...
            try {
                if (f.opts.fileUploadToS3) if (201 == t) {
                    var n = function (e) {
                        try {
                            var t = E(e).find("Location").text(), i = E(e).find("Key").text();
                    ...
                    n && h(n, e, i || r)
                } else U(u, i || r); else if (200 <= t && t < 300) {
                    var a = function (e) {
                        try {
        ...
        function a(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if ((null === f.opts.fileUploadURL || f.opts.fileUploadURL == p) && !f.opts.fileUploadToS3) return s = i, (l = new FileReader).addEventListener("load", function () {
                    ...
                    e = window.URL.createObjectURL(new Blob([new Uint8Array(i)], {type: s.type})), f.file.insert(e, s.name, null)
        ...
        function C() {
            var e, t = Array.prototype.slice.call(f.el.querySelectorAll("a.fr-file")), i = [];
        ...
        return i[1] = "File cannot be loaded from the passed link.", i[l] = "No link in upload response.", i[d] = "Error during file upload.", i[u] = "Parsing response failed.", i[c] = "File is too large.", i[v] = "File file type is invalid.", i[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", {
            _init: function () {
                f.events.on("drop", t), f.events.$on(f.$win, "keydown", function (e) {
                    var t = e.which, i = f.popups.get("file.insert");
            ...
            }, upload: a, insert: h, back: function () {
        ...
        plugin: "file"
    }), E.FE.DefineIcon("fileBack", {NAME: "arrow-left"}), E.FE.RegisterCommand("fileBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
