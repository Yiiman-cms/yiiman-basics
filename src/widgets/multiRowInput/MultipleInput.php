...
use YiiMan\YiiBasics\widgets\multiRowInput\renderers\TableRenderer;
use YiiMan\YiiBasics\widgets\multiRowInput\renderers\RendererInterface;
...
class MultipleInput extends InputWidget
{
     ...
     * Defaults to `YiiMan\YiiBasics\widgets\multiRowInput\MultipleInputColumn`
     */
    public $columnClass;

    /**
     * @var string the name of renderer class. Defaults to `YiiMan\YiiBasics\widgets\multiRowInput\renderers\TableRenderer`.
     * @since 1.4
     */
