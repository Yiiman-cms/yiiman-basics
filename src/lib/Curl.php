...
use YiiMan\YiiBasics\lib\curl\ArrayUtil;
use YiiMan\YiiBasics\lib\curl\CaseInsensitiveArray;
use YiiMan\YiiBasics\lib\curl\Decoder;
use YiiMan\YiiBasics\lib\curl\Url;
...
class Curl extends Component
{
    ...
    {
        $return = null;
        if (in_array($name, self::$deferredProperties) && is_callable([
                $this,
                $getter = '__get_'.$name
            ])) {
