...
class I18N extends Component
{
    ...
    public function translate($category, $message, $params, $language)
    {
        ...
        if (false != $cachee) {
            return $this->format(str_replace(['[', ']'], ['{', '}'], $cachee), $params, $language);
        }
...
//        }
        ...
        if (!$translation) {
            $translation = $messageSource->translate($category, str_replace(['{', '}'], ['[', ']'], $message), $language);
        }
        $translation = $this->format(str_replace(['[', ']'], ['{', '}'], $translation), $params, $language);
