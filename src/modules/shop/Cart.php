...
class Cart extends BaseObject
{
     ...
     */
    public $storageClass = 'YiiMan\YiiBasics\modules\shop\storage\SessionStorage';

    /**
     * @var string $calculatorClass
     */
    public $calculatorClass = 'YiiMan\YiiBasics\modules\shop\calculators\SimpleCalculator';
    ...
    /**
     * @var \YiiMan\YiiBasics\modules\shop\storage\StorageInterface
     */
    private $storage;

    /**
     * @var \YiiMan\YiiBasics\modules\shop\calculators\CalculatorInterface
     */
    private $calculator;
