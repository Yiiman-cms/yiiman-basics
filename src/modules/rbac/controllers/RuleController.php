<?php
	...
	use YiiMan\YiiBasics\modules\rbac\models\Rule;
	use YiiMan\YiiBasics\modules\rbac\models\RuleSearch;
	 ...
	 * @since  1.0.0
	 */
	class RuleController extends \YiiMan\YiiBasics\lib\Controller {
			...
			if ( $request->isAjax ) {
				...
				if ( $request->isGet ) {
					...
					return [
						...
						'content'     => '<span class="text-success">' . Yii::t(
								'rbac' ,
