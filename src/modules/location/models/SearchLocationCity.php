...
/**
 * SearchLocationCity represents the model behind the search form of `YiiMan\YiiBasics\modules\location\models\LocationCity`.
 */
class SearchLocationCity extends LocationCity
{
    /**
     * {@inheritdoc}
     */
