                ...
                <div class="card-body ">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <?php   ?>
                                <?= $form->field($model, 'subject')->textInput(Yii::$app->controller->action->id=='create'?[]:['disabled'=>'disabled']) ?>
                            </div>
                            <div class="col-md-6">
                                <?= $form->field($model, 'department')->widget(Select2::className(),
                                    [
                                        'data' => \yii\helpers\ArrayHelper::map(\YiiMan\YiiBasics\modules\ticket\models\TicketDepartments::find()->all(), 'id', 'title'),
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <?= $form->field($model, 'uid')->widget(Select2::className(),
                                        [
                                            'data' => \yii\helpers\ArrayHelper::map(\YiiMan\YiiBasics\modules\user\models\User::find()->all(), 'id', 'username'),
                                            'options' =>
                                                [
                                                    'dir' => 'rtl',
