...
{
return [
            [['uid', 'message', 'target_module', 'notif_channel', 'created_at', 'created_by', 'details_json', 'status'], 'required'],
            [['uid', 'module_id', 'created_by', 'status', 'language', 'language_parent'], 'integer'],
            [['created_at', 'sent_at'], 'safe'],
            [['details_json'], 'string'],
            [['message'], 'string', 'max' => 1000],
            [['target_module', 'notif_channel'], 'string', 'max' => 300],
            [['send_error'], 'string', 'max' => 700],
