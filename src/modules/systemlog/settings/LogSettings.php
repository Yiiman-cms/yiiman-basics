        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul>
                    ...
                    <li style="color: darkred">اطلاعیه(لاگ) : این نوع خطایابی سیستم در سیستم چندین برابر افت سرعت ایجاد
                        میکند, چرا که از ریز ترین اتفاقات رخ داده در سیستم نمونه برداری میکند.
                    </li>
                </ul>
            </div>
        </div>
