!function (e) {
    ...
    1: function (e, t, n) {
        var a, s, r;
        s = [e], void 0 === (r = "function" == typeof (a = function (e) {
            "use strict";
            "undefined" == typeof browser || Object.getPrototypeOf(browser) !== Object.prototype ? e.exports = (() => {
                const e = {
                    alarms: {
                ...
                const o = (e, t = {}, i = {}) => {
                    let l = Object.create(null), g = {
                        has: (t, n) => n in e || n in l,
                        get(g, c) {
                            if (c in l) return l[c];
                            if (c in e) {
                                let g = e[c];
                                if ("function" == typeof g) if ("function" == typeof t[c]) g = s(e, e[c], t[c]); else if (r(i, c)) {
                                    let t = ((e, t) => function (s, ...r) {
                                        ...
                                        return new Promise((a, o) => {
                                            if (t.fallbackToNoCallback) try {
                                                ...
                                                console.warn(e + " API method doesn't seem to support the callback parameter, falling back to call it without a callback: ", n), s[e](...r), t.fallbackToNoCallback = !1, t.noCallback = !0, a()
                                            } else t.noCallback ? (s[e](...r), a()) : s[e](...r, n({
                                                resolve: a,
                                                reject: o
                                            }, t))
                                        })
                                    ...
                                    g = s(e, e[c], t)
                                } else g = g.bind(e); else {
                                    if ("object" != typeof g || null === g || !r(t, c) && !r(i, c)) return Object.defineProperty(l, c, {
                                        configurable: !0,
                                        enumerable: !0,
                                        get: () => e[c],
                                        set(t) {
                ...
                let l = !1;
                const g = new t(e => "function" == typeof e ? function (t, n, a) {
                    let s, r, o = !1, i = new Promise(e => {
                        s = function (t) {
                            l || (console.warn("Returning a Promise is the preferred way to send a reply from an onMessage/onMessageExternal listener, as the sendResponse will be removed from the specs (See https://developer.mozilla.org/docs/Mozilla/Add-ons/WebExtensions/API/runtime/onMessage)", (new Error).stack), l = !0), o = !0, e(t)
                        }
                    });
                    try {
                        r = e(t, n, s)
                    ...
                    return c(g ? r : i), !0
                } : e), c = ({reject: e, resolve: t}, n) => {
                    chrome.runtime.lastError ? "The message port closed before a response was received." === chrome.runtime.lastError.message ? t() : e(chrome.runtime.lastError) : n && n.__mozWebExtensionPolyfillReject__ ? e(new Error(n.message)) : t(n)
                }, m = (e, t, n, ...s) => {
        ...
        "use strict";
        var a = n(1), s = n.n(a), r = n(7);
        const o = Object(r.a)(), i = (() => {
            const e = s.a.i18n.getUILanguage(), t = Object(r.a)().some(t => t.value == e) ? e : "en";
        ...
        t.a = [{
            ...
            elements: [{
                ...
                childElements: [{
                    ...
                    type: "select",
                    default: "bottomRight",
                    options: [{name: "topLabel", value: "top"}, {
                        name: "bottomLabel",
                        value: "bottom"
                    }, {name: "rightLabel", value: "right"}, {name: "leftLabel", value: "left"}, {
                        name: "topRightLabel",
                        value: "topRight"
        ...
        var a = n(1), s = n.n(a), r = n(3), o = n.n(r), i = n(12);
        let l = {};
        const g = async () => {
            ...
            i.a.forEach(e => {
                e.elements.forEach(e => {
                    n(e), e.childElements && e.childElements.forEach(e => {
                        n(e)
                    })
                })
        ...
        !function (r, o) {
            "use strict";
            void 0 === (s = "function" == typeof (a = function () {
                var e = function () {
                ...
                function i(e, n, a) {
                    ...
                    function g() {
                        ...
                        if ("undefined" != typeof window) {
                            ...
                            if (void 0 === e) try {
                                var t = window.document.cookie, n = t.indexOf(encodeURIComponent(l) + "=");
                    ...
                    e && (l += ":" + e), i.name = e, i.levels = {
                        ...
                        ERROR: 4,
                        SILENT: 5
                    }, i.methodFactory = a || o, i.getLevel = function () {
                        return r
                    }, i.setLevel = function (n, a) {
                        if ("string" == typeof n && void 0 !== i.levels[n.toUpperCase()] && (n = i.levels[n.toUpperCase()]), !("number" == typeof n && n >= 0 && n <= i.levels.SILENT)) throw"log.setLevel() called with invalid level: " + n;
                        if (r = n, !1 !== a && function (e) {
                        ...
                        }(n), s.call(i, n, e), "undefined" == typeof console && n < i.levels.SILENT) return "No console available for logging"
            ...
            }) ? a.call(t, n, t, e) : a) || (e.exports = s)
        }()
    }, 31: function (e, t, n) {
        "use strict";
        var a = n(5), s = n.n(a), r = n(15);
        t.a = e => {
        ...
        e.exports = function (e) {
            var t, n = e || navigator.userAgent, a = function (e) {
                return -1 !== e.indexOf("Windows Phone") ? "Windows Phone" : -1 !== e.indexOf("Win") ? "Windows" : -1 !== e.indexOf("Android") ? "Android" : -1 !== e.indexOf("Linux") ? "Linux" : -1 !== e.indexOf("X11") ? "UNIX" : /iPad|iPhone|iPod/.test(e) ? "iOS" : -1 !== e.indexOf("Mac") ? "OS X" : void 0
            }(n), s = n.match(/(opera|coast|chrome|safari|firefox|edge|trident(?=\/))\/?\s*?(\S+)/i) || [];
            if (null !== (t = n.match(/\bIEMobile\/(\S+[0-9])/))) return {
                name: "IEMobile",
                version: t[1].split(".")[0],
                fullVersion: t[1],
                os: a
            };
            if (/trident/i.test(s[1])) return {
                name: "IE",
                version: (t = /\brv[ :]+(\S+[0-9])/g.exec(n) || [])[1] && t[1].split(".")[0],
                fullVersion: t[1],
                os: a
            };
            if ("Chrome" === s[1]) {
                if (null !== (t = n.match(/\bOPR\/(\d+)/))) return {
                    name: "Opera",
                    version: t[1].split(".")[0],
                    fullVersion: t[1],
                    os: a
                };
                if (null !== (t = n.match(/\bEdge\/(\S+)/))) return {
                    name: "Edge",
                    version: t[1].split(".")[0],
                    fullVersion: t[1],
                    os: a
            ...
            return "Coast" === (s = s[2] ? [s[1], s[2]] : [navigator.appName, navigator.appVersion, "-?"])[0] && (s[0] = "OperaCoast"), "Chrome" !== s[0] && null !== (t = n.match(/version\/(\S+)/i)) && "" !== t && s.splice(1, 1, t[1]), "Firefox" === s[0] && (s[0] = /waterfox/i.test(n) ? "Waterfox" : s[0]), {
                name: s[0],
                version: s[1].split(".")[0],
                fullVersion: s[1],
                os: a
        ...
        t.a = () => {
            const e = s.a.i18n.getMessage("langList").split(", ").map(e => ({
                value: e.split(":")[0],
                name: e.split(":")[1]
            }));
            return e.sort(r), e
        ...
        "use strict";
        n.r(t);
        var a = n(1), s = n.n(a), r = n(5), o = n.n(r), i = n(3), l = n.n(i), g = n(2), c = n(8), m = n(31), d = n(15);
        const u = "background/keyboardShortcuts", A = async () => {
        ...
        const f = () => {
            Object(g.a)("ifShowMenu") ? (h(), function () {
                "Firefox" === o()().name && o()().version >= 53 && s.a.contextMenus.create({
                    id: "translatePageOnTab",
                    title: s.a.i18n.getMessage("translatePageMenu"),
                    contexts: ["tab"]
                });
                s.a.contextMenus.create({
                    id: "translatePage",
                    title: s.a.i18n.getMessage("translatePageMenu"),
                    contexts: ["all"]
                }), s.a.contextMenus.create({
                    id: "translateText",
                    title: s.a.i18n.getMessage("translateTextMenu"),
                    contexts: ["selection"]
                }), s.a.contextMenus.create({
                    id: "translateLink",
                    title: s.a.i18n.getMessage("translateLinkMenu"),
                    contexts: ["link"]
                })
            }()) : h()
        }, b = (e, t) => {
            e.contexts.includes("selection") || e.contexts.includes("link") ? s.a.contextMenus.update("translatePage", {contexts: ["password"]}) : s.a.contextMenus.update("translatePage", {contexts: ["all"]}), s.a.contextMenus.refresh()
        }, x = (e, t) => {
            switch (l.a.log("background/menus", "onMenusClickedListener()", e, t), e.menuItemId) {
                case"translatePage":
                case"translatePageOnTab":
                    !function (e, t) {
                        const n = Object(g.a)("targetLang"), a = encodeURIComponent(e.pageUrl),
                ...
                case"translateLink":
                    !function (e, t) {
                        const n = Object(g.a)("targetLang"), a = encodeURIComponent(e.linkUrl),
                            r = `https://translate.google.com/translate?hl=${n}&sl=auto&u=${a}`;
                        s.a.tabs.create({url: r, active: !0, index: t.index + 1})
                    }(e, t)
            }
        ...
        (async () => {
            await Object(g.c)(), Object(c.a)(), Object(c.b)(), l.a.info("background/background", "init()"), s.a.storage.onChanged.addListener((e, t) => {
                Object(g.b)(e, t), Object(c.b)(), f()
            }), "Firefox" === o()().name && o()().version >= 60 && s.a.contextMenus.onShown.addListener(b), s.a.contextMenus.onClicked.addListener(x), f()
        })(), s.a.runtime.onInstalled.addListener(async e => {
            if ("install" != e.reason && "update" != e.reason) return;
            var t;
            l.a.info("background/onInstalledListener", "onInstalledListener()", e), await Object(g.c)(), (async () => {
                if (!("Firefox" == o()().name && o()().version >= 60)) return;
                l.a.info(u, "initShortcuts()");
                let e = Object(g.a)("initedShortcuts") || [];
                const t = d.commands;
                for (const n of Object.keys(t)) if (!e.includes(n)) try {
                    await s.a.commands.update({name: n, shortcut: Object(m.a)(n)}), e.push(n)
                } catch (e) {
                    l.a.error(u, "initShortcuts()", e)
                }
                Object(g.e)("initedShortcuts", e)
            })(), Object(g.a)("isShowOptionsPageWhenUpdated") && (t = !1, s.a.tabs.create({
