...
<div class="gallery-fk-medias-categories-form">
            ...
            <div class="row">
                <div class="card card-nav-tabs" style="margin-top: 20px ">
                    <div class="card-body ">
                        ...
                        <div class="row">
                            <div class="col-md-12 pull-right">
                                <?= $form->field($model, 'media')->widget(
                                    \kartik\select2\Select2::className(),
                                    [
                                        'data'          => \yii\helpers\ArrayHelper::map(
                                            \YiiMan\YiiBasics\modules\gallery\models\GalleryMedias::find()->where(['language_parent' => null])->all(),
                                            'id',
                                            'title'
                                        ),
