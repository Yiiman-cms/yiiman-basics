...
Vvveb.Components.add("components/products", {
    ...
    image: asseturlt+"libs/builder/"+"icons/products.svg",
...
Vvveb.Components.add("components/manufacturers", {
    ...
    image: asseturlt+"libs/builder/"+"icons/categories.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        nolabel:false,
        inputtype: TextInput,
...
Vvveb.Components.add("components/search", {
    ...
    image: asseturlt+"libs/builder/"+"icons/search.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/user", {
    ...
    image: asseturlt+"libs/builder/"+"icons/user.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/product_gallery", {
    ...
    image:asseturlt+"libs/builder/"+ "icons/product_gallery.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/cart", {
    ...
    image: asseturlt+"libs/builder/"+"icons/cart.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/checkout", {
    ...
    image: asseturlt+"libs/builder/"+"icons/checkout.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/filters", {
    ...
    image: asseturlt+"libs/builder/"+"icons/filters.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/product", {
    ...
    image: asseturlt+"libs/builder/"+"icons/product.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/slider", {
    ...
    image: asseturlt+"libs/builder/"+"icons/slider.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
