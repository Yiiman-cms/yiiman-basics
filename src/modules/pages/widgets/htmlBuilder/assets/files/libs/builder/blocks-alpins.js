...
Vvveb.BlocksGroup['Alpins Snippets'] =
["Alpins/Team1"];


Vvveb.Blocks.add("Alpins/Team1", {
    name: "لیست تیم ها به صورت ایکجسی",
	dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',    
    image: asseturlt+"libs/builder/icons/sign-in-split.jpg",
    html: `
...
Vvveb.Blocks.add("bootstrap4/image-gallery", {
    name: "Image gallery",
    image: asseturlt+"libs/builder/icons/thumbnail-gallery.jpg",
	dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',    
    html: `
<div class="container">
...
Vvveb.Blocks.add("bootstrap4/slider-header", {
	...
	dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',        
    image: asseturlt+"libs/builder/icons/full-slider.jpg",
    html:`
<header class="slider">
...
Vvveb.Blocks.add("bootstrap4/video-header", {
    ...
    image: asseturlt+"libs/builder/icons/video-header.jpg",
    html:`
<header class="video">
...
Vvveb.Blocks.add("bootstrap4/about-team", {
	...
	dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/image.svg">',        
    image: asseturlt+"libs/builder/icons/about-team.jpg",
    html:`
...
Vvveb.Blocks.add("bootstrap4/portfolio-one-column", {
	...
	dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/image.svg">',        
    image: asseturlt+"libs/builder/icons/portfolio-one-column.jpg",
    html:`
    <div class="container">
...
Vvveb.Blocks.add("bootstrap4/portfolio-three-column", {
	...
	dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/image.svg">',        
    image: asseturlt+"libs/builder/icons/portfolio-three-column.jpg",
    html:`
<div class="container">
...
Vvveb.Blocks.add("bootstrap4/portfolio-four-column", {
	...
	dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/image.svg">',        
    image: asseturlt+"libs/builder/icons/portfolio-four-column.jpg",
    html:`
<div class="container">
