...
Vvveb.Components.extend("_base", "html/accordionGroup", {
    name: "لیست باکس آکاردئونی",
    ...
    `,
    classes: ["accordion", "accordion-bg", "accordion-gutter-md", "accordion-border"],
    properties: [{
        name: "Value",
        key: "value",
        htmlAttr: "value",
...
<div class="accordion accordion-bg accordion-gutter-md accordion-border">
                            <div class="card">
                                <div class="card-header">
                                    <a href="#collapse1-1" class="collapse">عنوان آکاردئون  1</a>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <a href="#collapse1-2" class="expand">عنوان آکاردئون  2</a>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <a href="#collapse1-3" class="expand">عنوان آکاردئون  3</a>
                                </div>
    ...
    beforeInit: function (node) {
        ...
        $(node).find('[class*="card"]').each(function () {
