...
Vvveb.Components.extend("_base", "widgets/googlemaps", {
    ...
    image: asseturlt + "libs/builder/" + "icons/map.svg",
...
Vvveb.Components.extend("_base", "5f85481eeccee/categoriesWidget", {
    attributes: ["data-component-categoriesWidget"],
    image: asseturlt + "libs/builder/" + "icons/container.svg",
    html: `<SYSTEMPARAMETER data-component-categoriesWidget name="categoriesWidget"  limit="limit" showCount="showCount">categoriesWidget</SYSTEMPARAMETER>`,
...
Vvveb.Components.extend("_base", "widgets/facebookcomments", {
    ...
    image: asseturlt + "libs/builder/" + "icons/facebook.svg",
...
Vvveb.Components.extend("_base", "widgets/instagram", {
    ...
    image: asseturlt + "libs/builder/" + "icons/instagram.svg",
...
Vvveb.Components.extend("_base", "widgets/twitter", {
    ...
    image: asseturlt + "libs/builder/" + "icons/twitter.svg",
...
Vvveb.Components.extend("_base", "widgets/paypal", {
    ...
    image: asseturlt + "libs/builder/" + "icons/paypal.svg",
...
Vvveb.Components.extend("_base", "widgets/chartjs", {
    ...
    image: asseturlt + "libs/builder/" + "icons/chart.svg",
