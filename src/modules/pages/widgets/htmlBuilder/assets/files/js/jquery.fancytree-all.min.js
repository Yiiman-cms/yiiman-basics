        ...
        /** @lends Fancytree_Hooks# */
        {
            ...
            nodeRenderTitle: function(ctx, title) {
                ...
                if (!nodeTitle) {
                    ...
                    // $(node.li).attr("onClick", "console.log(event);event.stopPropagation();Vvveb.Sections.treeSelected('"+node.li.id+"')");

                    nodeTitle =
                        "<span class='fancytree-title'" +
                        tooltip +
                        tabindex +
                        " onClick=\"Vvveb.Sections.treeSelected('"+node.li.id+"')\" " +
                        " onmouseover=\"Vvveb.Sections.treeSelected('"+node.li.id+"')\" " +
                       " >" +
                        (opts.escapeTitles
                            ? FT.escapeHtml(node.title)
                            : node.title) +
                        "<div class=\"buttons\">\n" +
                        "            <span onClick=\"Vvveb.Sections.treeDelete('"+node.li.id+"',event)\" class=\"delete-btn\" title=\"حذف این المان\"><i class=\"la la-trash text-danger\"></i></span>\n" +
                        "            <span onClick=\"Vvveb.Sections.treeUp('"+node.li.id+"',event)\" class=\"up-btn\" title=\"انتقال المنت به بالا\"><i class=\"la la-arrow-up\"></i></span>\n" +
                        "            <span onClick=\"Vvveb.Sections.treeDown('"+node.li.id+"',event)\" class=\"down-btn\" title=\"انتقال المنت به پایین\"><i class=\"la la-arrow-down\"></i></span>\n" +
                        "            <span onClick=\"Vvveb.Sections.treeClone('"+node.li.id+"',event)\" class=\"properties-btn\" title=\"ایجاد کپی از این المان\"><i class=\"la la-copy\"></i></span>\n" +
                        "        </div>" +
                        "" +
                        "</span>";
                }
