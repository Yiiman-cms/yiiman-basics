...
module.exports = function (e) {
    ...
    }(r), u = n(2), s = i(u), l = n(3), c = i(l), g = novi.react.React, f = novi.language, p = {
        name: "novi-plugin-background-image",
        title: "Novi Background Image",
        description: "Novi Background Image description",
        version: "1.1.0",
        dependencies: {novi: "0.9.0"},
        defaults: {querySelector: '[class*="custom-bg-image"]', childQuerySelector: '[class*="custom-bg-image-image"]'},
        ui: {editor: [s.default], settings: g.createElement(c.default, null)},
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.validBgImage = n
}, function (e, t) {
    "use strict";

    function n(e) {
        var t = e.offsetWidth / e.offsetHeight;
        novi.media.choose({onSubmit: i.bind(this, e), ratio: t, type: r.mediaImage})
    }
    ...
    var o = (novi.react.React, novi.ui.icons), r = novi.types, a = {
    ...
    var r = function () {
        ...
        }(), a = novi.react.React, u = novi.react.Component, s = novi.ui.input, l = novi.ui.button, c = novi.language,
        g = function (e) {
            function t(e) {
                n(this, t);
                var o = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this));
                return o.state = {settings: e.settings}, o.saveSettings = o.saveSettings.bind(o), o.onChange = o.onChange.bind(o), o.messages = c.getDataByKey("novi-plugin-background-image"), o
            }
            ...
            return o(t, e), r(t, [{
                ...
                key: "render", value: function () {
                    return a.createElement("div", null, a.createElement("span", {style: {letterSpacing: "0,0462em"}}, "Background Image Plugin"), a.createElement("div", {
                        style: {
                            fontSize: 13,
                            color: "#6E778A",
                            marginTop: 21
                    ...
                    }), a.createElement("div", {style: {marginTop: 30}}, a.createElement(l, {
                        type: "primary",
                ...
                key: "onChange", value: function (e) {
                    this.setState({settings: {querySelector: e.target.value}})
                }
            }, {
