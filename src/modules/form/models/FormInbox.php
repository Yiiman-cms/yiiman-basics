...
{
return [
            [['created_at', 'status', 'details', 'form'], 'required'],
            [['created_at'], 'safe'],
            [['status', 'form'], 'integer'],
            [['ip'], 'string', 'max' => 15],
            [[ 'title'], 'string', 'max' => 255],
            [['form'], 'exist', 'skipOnError' => true, 'targetClass' =>\YiiMan\YiiBasics\modules\form\models\Form::className(), 'targetAttribute' => ['form' => 'id']],
        ];
}
