...
class Menu extends \yii\db\ActiveRecord
{
    public $parent;
    public $right;
    public $child;//برای انتخاب زیر منوی سطح 1 استفاده میشود
    public $child2;//برای انتخاب سطح سوم استفاده میشود
    public $pos;
    ...
    public function rules()
    {
        return
            [
                [['name', 'menuType', 'menuContentType'], 'required'],
                [
                    ['parent_id', 'parent', 'right', 'child', 'child2', 'column', 'enable', 'position'],
                    'integer'
                ],
                [['name', 'icon', 'menuType','menuContentType'], 'string', 'max' => 100],
                [['name', 'img'], 'string', 'max' => 100],
                [['url', 'hyper_url', 'pos'], 'string', 'max' => 1000],
