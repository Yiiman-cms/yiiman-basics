...
class Widget extends \YiiMan\YiiBasics\lib\ActiveRecord
{
    ...
    public static function getLoadedWidget()
    {
        ...
        $models = self::find()->select([
            'shortCode',
            'id'
        ])->where(['language' => Yii::$app->Language->contentLanguageID()])->asArray()->all();
    ...
    public function rules()
    {
        return [
            ...
            [
                ...
                'exist',
                'skipOnError'     => true,
                'targetClass'     => \YiiMan\YiiBasics\modules\widget\models\Widget::className(),
