                            ...
                            <div class="col-md-12 pull-right">
                                <?= $form->field($model, 'status')->widget(
                                    ...
                                    [
                                        'data' =>
                                            [
                                                \YiiMan\YiiBasics\modules\blog\models\BlogComment::STATUS_ACTIVE => \Yii::t('site', 'منتشر شده'),
                                                \YiiMan\YiiBasics\modules\blog\models\BlogComment::STATUS_WAITING => \Yii::t('site', 'در حال انتظار'),
                                                \YiiMan\YiiBasics\modules\blog\models\BlogComment::STATUS_DE_ACTIVE => \Yii::t('site', 'جفنگ')
                                            ],
                                        'options' => ['dir' => 'rtl'],
                ...
                <div class="card-body ">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4"><?= $form->field($model, 'website')->textInput(['maxlength' => true]) ?></div>

                            <div class="col-md-12"><?= $form->field($model, 'message')->textarea(['maxlength' => true]) ?></div>
